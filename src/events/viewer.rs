...
fn apply_viewer_menu_selection(
    ...
    match menu.kind {
        ...
        ViewerMenuKind::Mask => match menu.cursor {
            ...
            1 => viewer.set_mask(Some(MaskKind::Markdown)),
            2 => viewer.set_mask(Some(MaskKind::C)),
            3 => viewer.set_mask(Some(MaskKind::Rust)),
            4 => viewer.set_mask(Some(MaskKind::JavaScript)),
            5 => viewer.set_mask(Some(MaskKind::Python)),
            6 => viewer.set_mask(Some(MaskKind::Php)),
            7 => viewer.set_mask(Some(MaskKind::Html)),
            8 => viewer.set_mask(Some(MaskKind::Css)),
            9 => viewer.set_mask(Some(MaskKind::Toml)),
            10 => viewer.set_mask(Some(MaskKind::Sql)),
            11 => viewer.set_mask(Some(MaskKind::Shell)),
            12 => viewer.set_mask(Some(MaskKind::Pascal)),
            13 => viewer.set_mask(Some(MaskKind::Assembler)),
            14 => viewer.set_mask(Some(MaskKind::Ketchup)),
